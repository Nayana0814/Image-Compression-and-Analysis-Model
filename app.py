...
if uploaded_file is not None:
    ...
    compressed_img = image.resize((64, 64), Image.LANCZOS)  # Compress to smaller size
    st.image(compressed_img, caption="Compressed Image (64x64)", use_container_width=True)
